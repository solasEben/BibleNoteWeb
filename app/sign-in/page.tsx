...
export default function SignIn() {
    return (
        <div className="flex min-h-screen items-center justify-center px-4 py-12">
            <div className="w-full max-w-md space-y-8 bg-surface p-10 rounded-[2rem] border border-white/5 shadow-2xl">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                type="email"
                                required
                                className="w-full bg-background border border-white/10 rounded-xl px-4 py-3 placeholder:text-muted/50 focus:border-primary outline-none transition-colors"
