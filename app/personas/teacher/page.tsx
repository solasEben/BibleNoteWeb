        ...
        <div className="pb-20">
            <section className="pt-32 pb-16 px-4 bg-warm/10">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="w-20 h-20 bg-accent-gold/20 rounded-2xl flex items-center justify-center mx-auto mb-8">
                        <GraduationCap className="w-10 h-10 text-accent-gold" />
                    </div>
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 text-foreground">The Teacher's Toolkit</h1>
            ...
            <div className="max-w-4xl mx-auto px-4 text-center">
                <Link href="/sign-up" className="inline-block bg-accent-gold text-background px-8 py-3 rounded-xl font-bold hover:scale-105 transition-transform">
