        ...
        <div className="pb-20">
            <section className="pt-32 pb-16 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 text-foreground">Experience Scripture Like Never Before</h1>
            ...
            <section className="py-24 px-4 bg-background border-y border-border">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div>
                        <h2 className="text-3xl font-bold mb-6 text-foreground">Design for Focus</h2>
                    ...
                    <div className="aspect-video bg-surface border border-border rounded-3xl relative overflow-hidden group">
